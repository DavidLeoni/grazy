...
declare module D3 {
    ...
    export interface Dsv {
        ...
        * @param url Url to request
        * @param callback Function to invoke when resource is loaded or the request fails
        */ // dav switched response and error
        (url: string, callback?: (response: any[], error: any) => void ): Xhr;
        /**
    ...
    export module Layout {
        ...
        export interface GraphNode {
            id?: number;  // stoc made optional
            index?: number; // stoc made optional
            name?: string;
            px: number;
            py: number;
            size: number;
        ...
        export interface ForceLayout {
            ...
            links: {
                (): GraphLink[];
                (arLinks: any[]): ForceLayout; // stoc 'any' was GraphLink

            };
            nodes:
            {
                (): GraphNode[]; 
                (arNodes: any[]): ForceLayout;  // stoc 'any' was GraphNode
            ...
            stop(): ForceLayout;
            tick(): ForceLayout;
            // dav added optional param to listener
            on(type: string, listener: (param: any) => void): ForceLayout;
            drag(): ForceLayout;
        }
