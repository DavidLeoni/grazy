    ...
    export class Editor {
        ...
        */
        ...
        restart() {
            ...
            this.path.classed('selected', (d) => (d === this.selected_link))
            ...
            this.path.enter().append('svg:path')
                .attr('class', 'link')
                .classed('selected', (d) => (d === this.selected_link))
                .style('marker-end', 'url(#arrow-1)')
                .on('mousedown', (d) => {
            ...
            g.append('svg:circle')
                ...
                .on('mouseup', function (d) {
                    ...
                    var link;
                    link = self.links.filter((l) => (l.source === source && l.target === target))[0];
        ...
        spliceLinksForNode(node) {
            ...
            toSplice.map((l) => this.links.splice(this.links.indexOf(l), 1));
        }
