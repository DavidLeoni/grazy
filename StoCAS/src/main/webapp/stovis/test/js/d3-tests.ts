...
module d3Tests {
    ...
    */
    export function davcsv(url, callback) {
    ...
    export function stickyEditor() {
        ...
        function restart() {
            ...
            path.classed('selected', function (d) { return d === selected_link; })              
                .style('marker-end', function (d) { return 'url(#arrow-1)';  });
