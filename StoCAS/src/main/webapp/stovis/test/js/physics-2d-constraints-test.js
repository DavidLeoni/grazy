// Module
var physics2DConstraintsTest;
(function (physics2DConstraintsTest) {
    physics2DConstraintsTest.DEFAULT_BACKGROUND_COLOR = "#2e2e2e";
    physics2DConstraintsTest.DEFAULT_FILL_COLOR = "#ffbaba";
    physics2DConstraintsTest.DEFAULT_STROKE_COLOR = "#ff7a7a";

    /** max field size in pixel */
    physics2DConstraintsTest.MAX_FIELD_LENGTH = 20000;
    ...
    */
    ...
    physics2DConstraintsTest.Editor = Editor;

    function addEditor(container) {
        return new Editor(container);
    }
    physics2DConstraintsTest.addEditor = addEditor;
})(physics2DConstraintsTest || (physics2DConstraintsTest = {}));
//# sourceMappingURL=physics-2d-constraints-test.js.map
