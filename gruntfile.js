    ...
    grunt.initConfig({
        ts: {
            ...
            dev: {
				...
				outDir : "js",
                src: ["mods/**/*.ts",
						'typings/**/*.ts'],          // The source typescript files, http://gruntjs.com/configuring-tasks#files
                html: ['mods/**/**.tpl.html'],  // The source html files, https://github.com/basarat/grunt-ts#html-2-typescript-support
                ...
                watch: ['mods'],                  // If specified, watches this directory for changes, and re-runs the current target
