// sto
// Quick hack: added declare module so we can access it from outside without using RequireJS/AMD 
// also removed internal 
// see http://stackoverflow.com/questions/18507058/typescript-module-functions-reference-in-different-file-could-not-find-symb
